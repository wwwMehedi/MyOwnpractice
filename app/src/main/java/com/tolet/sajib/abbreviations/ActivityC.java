...
public class ActivityC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:C");
    ...
    public void preparelistdata() {
        String[] headerString = getResources().getStringArray(R.array.cparent);
        String[] childString = getResources().getStringArray(R.array.cchild);
