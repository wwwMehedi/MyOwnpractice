...
public class ActivityN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:N");
    ...
    public void preparelistdata() {
        ...
        String[] headerString = getResources().getStringArray(R.array.nparent);
        String[] childString = getResources().getStringArray(R.array.nchild);
