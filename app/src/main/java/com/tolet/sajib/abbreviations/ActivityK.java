...
public class ActivityK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:K");
    ...
    public void preparelistdata() {
        String[] headerString = getResources().getStringArray(R.array.kparent);
        String[] childString = getResources().getStringArray(R.array.kchild);
