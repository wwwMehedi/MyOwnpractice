...
public class ActivityT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:T");
    ...
    public void preparelistdata() {
        ...
        String[] headerString = getResources().getStringArray(R.array.tparent);
        String[] childString = getResources().getStringArray(R.array.tchild);
