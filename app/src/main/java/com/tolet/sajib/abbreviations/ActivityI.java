...
public class ActivityI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:I");
    ...
    public void preparelistdata() {
        String[] headerString = getResources().getStringArray(R.array.iparent);
        String[] childString = getResources().getStringArray(R.array.ichild);
