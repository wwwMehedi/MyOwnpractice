...
public class ActivityL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:L");
    ...
    public void preparelistdata() {
        String[] headerString = getResources().getStringArray(R.array.lparent);
        String[] childString = getResources().getStringArray(R.array.lchild);
