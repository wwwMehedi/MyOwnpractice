...
public class ActivityP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:P");
    ...
    public void preparelistdata() {
        ...
        String[] headerString = getResources().getStringArray(R.array.pparent);
        String[] childString = getResources().getStringArray(R.array.pchild);
