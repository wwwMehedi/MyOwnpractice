...
public class ActivityR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:R");
    ...
    public void preparelistdata() {
        ...
        String[] headerString = getResources().getStringArray(R.array.rparent);
        String[] childString = getResources().getStringArray(R.array.rchild);
