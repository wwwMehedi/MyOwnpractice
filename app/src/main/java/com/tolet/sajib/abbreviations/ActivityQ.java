...
public class ActivityQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:Q");
    ...
    public void preparelistdata() {
        ...
        String[] headerString = getResources().getStringArray(R.array.qparennt);
        String[] childString = getResources().getStringArray(R.array.qchilld);
