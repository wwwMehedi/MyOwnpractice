...
public class ActivityO extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:O");
    ...
    public void preparelistdata() {
        ...
        String[] headerString = getResources().getStringArray(R.array.oparent);
        String[] childString = getResources().getStringArray(R.array.ochild);
