...
public class ActivityJ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:J");
    ...
    public void preparelistdata() {
        String[] headerString = getResources().getStringArray(R.array.jparent);
        String[] childString = getResources().getStringArray(R.array.jchild);
