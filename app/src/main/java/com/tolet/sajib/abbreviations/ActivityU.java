...
public class ActivityU extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:U");
    ...
    public void preparelistdata() {
        ...
        String[] headerString = getResources().getStringArray(R.array.uparent);
        String[] childString = getResources().getStringArray(R.array.uchild);
