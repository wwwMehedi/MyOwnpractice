...
public class ActivityH extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:H");
    ...
    public void preparelistdata() {
        String[] headerString = getResources().getStringArray(R.array.hparent);
        String[] childString = getResources().getStringArray(R.array.hchild);
