...
public class ActivityF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:F");
    ...
    public void preparelistdata() {
        String[] headerString = getResources().getStringArray(R.array.fparent);
        String[] childString = getResources().getStringArray(R.array.fchild);
