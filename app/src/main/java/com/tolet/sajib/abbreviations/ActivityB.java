...
public class ActivityB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:B");
    ...
    public void preparelistdata() {
        String[] headerString = getResources().getStringArray(R.array.bparent_name);
        String[] childString = getResources().getStringArray(R.array.chilb);
