...
public class ActivityS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:S");
    ...
    public void preparelistdata() {
        ...
        String[] headerString = getResources().getStringArray(R.array.sparent);
        String[] childString = getResources().getStringArray(R.array.schild);
