...
public class ActivityV extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:V");
    ...
    public void preparelistdata() {
        ...
        String[] headerString = getResources().getStringArray(R.array.vparent);
        String[] childString = getResources().getStringArray(R.array.vchild);
