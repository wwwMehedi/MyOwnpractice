...
public class ActivityX extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:X");
    ...
    public void preparelistdata() {
        ...
        String[] headerString = getResources().getStringArray(R.array.xparent);
        String[] childString = getResources().getStringArray(R.array.xchild);
