...
public class ActivityY extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:Y");
    ...
    public void preparelistdata() {
        ...
        String[] headerString = getResources().getStringArray(R.array.yparent);
        String[] childString = getResources().getStringArray(R.array.ychild);
