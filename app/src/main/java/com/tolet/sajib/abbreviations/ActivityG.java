...
public class ActivityG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbar.setTitle("Abbreviations:G");
    ...
    public void preparelistdata() {
        String[] headerString = getResources().getStringArray(R.array.gparent);
        String[] childString = getResources().getStringArray(R.array.gchild);
